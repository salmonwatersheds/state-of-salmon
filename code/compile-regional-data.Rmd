...
nassse <- read.csv("../data/nassskeena_sockeye_lgl.csv") %>%
	...
	bind_rows(
		data.frame(Year = c(2023:2025),
							 ...
							 source_id = rep("Nisgaa_20241203", 3)
		)
	)
