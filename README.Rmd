...
Code here is written by Steph Peacock and Eric Hertz. PSF's State of Salmon reporting is led by Eileen Jones and funded by the [Pacific Salmon Foundation](www.psf.ca).

### More information

* Technical Documentation of the data sources and approach can be found at https://salmonwatersheds.github.io/state-of-salmon/. 
* Output data sets provided here in `output` are available through the Salmon Watershed Program's [Data Library](https://data.salmonwatersheds.ca/) with associated metdata and citation information.
* If you have questions or would like more information, contact Steph Peacock <speacock@psf.ca>.