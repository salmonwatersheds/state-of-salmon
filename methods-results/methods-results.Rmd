...
```{r, echo = FALSE, include = TRUE, results = 'asis', fig.width = 7, fig.height = 6, fig.cap = "**Above:** Sockeye salmon spawner abundance (open points) and total abundance (closed points) in the Taku (red) and Stikine (blue)."}
...
plot(tbrse_taku$Year, tbrse_taku$Escapement*10^-3, "o", col = 2, pch = 21, bg = "white", ylim = c(0, 400), xlab = "", bty = "l", ylab = "Abundance (thousands)", las = 1, yaxs = "i")
...
legend("topright", col = c(2,4), pch = 19, lwd = 1, c("Taku", "Stikine"), bty = "n")
