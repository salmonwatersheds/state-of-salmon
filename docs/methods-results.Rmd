...
* All species for which we had reliable data have declined over long- and short-time frames.
...
* As for sockeye, Chinook spawner abundance is below historical average and run size is even further below historical average. However some life-history types are doing better than others [@Atlas2023], highlighting the need to conserve the within-species diversity that makes salmon resilient to environmental change.
