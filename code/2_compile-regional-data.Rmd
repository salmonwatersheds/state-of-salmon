...
# From PSC 
frpk <- read.csv(here("data/pink_run_size_2025-04-24.csv")) # No changes from Apr 24, 2025 version to Sept 18, 2025, but cite Sept because fraser sockeye in-season estimate for 2024 DID change (and don't want to change that number at this point)
...
## Load data ---
# From PSC
frse <- read.csv(here("data/Fraser Sockeye Run Size_2025-04-24.csv")) %>%
